...
import il.co.topq.jsystem.DatasourceOutputHandler;
...
public class DatabaseOperations extends SystemTestCase4 {
	...
	public void setUp() throws Exception {
		...
		handler = (DatasourceOutputHandler) system.getSystemObject("dsHandler");
	}
	...
	/**
	 * Executes a query, and handles the results with a given {@link DatasourceOutputHandler}
	 * @throws Exception
	 */
	@TestProperties(name = "EXECUTES query: ${query}", paramsInclude = { "query"})
	@Test
	public void queryWithHandler() throws Exception {
		db.executeSelectStatementWithHandler(query, handler);
	}
